(function (k, f, c, j, d, l, g) {/*! Jssor */
    ...
    var b = new function () {
        ...
        h.Zf = function (d, a) {
            if (a)d.style.clip = "rect(" + c.round(a.$Top || a.H || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.I || 0) + "px)"; else if (a !== g) {
        ...
        function w(f, l) {
            ...
            w = function (e, c) {
                ...
                if (c.Re)if (d)yb(h.E(j, O, e, c)); else a(e, c)
            };
            h.Eb = O;
            if (d)h.Eb = w;
            if (e)h.Eb = a; else if (!b)a = O;
            h.K = w;
            w(f, l)
        }
            ...
            z.dc = function (d) {
                ...
                if (e || y) {
                    ...
                    b.a(i, function (a, e) {
                        ...
                        if (a.ud != d) {
                            if (!a.ud && !k)b.u(n[e]); else d == a.ee && k && b.Q(n[e]);
                            a.ud = d;
                            b.K(n[e], a[d])
                        }
                    })
    ...
    var i = k.$JssorSlider$ = function (p, hc) {
        ...
        function Bc(k, f) {
            ...
            function T(a, c, e) {
                ...
                b.a(f, function (f) {
                    ...
                    if (i == "player" && !v) {
                        v = f;
                        if (v.pInstance)O(); else b.c(v, "dataavailable", O)
                    }
                    if (i == "caption") {
                        if (c) {
                            b.Ic(f, b.j(f, "to"));
        ...
        b.a(yc, function (a) {
            if (a.tagName == "DIV" && !b.j(a, "u"))T.push(a); else b.fb() && b.F(a, (b.F(a) || 0) + 1)
        });
