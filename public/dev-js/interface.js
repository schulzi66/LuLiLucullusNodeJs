    ...
    socket.on('loadedRecipesOverview', function (recipes) {
        ...
        $.each(recipes, function (i) {
            var recipe_list_element =
                ...
                '<div class="thumbnail">' +
                '<img src="img/recipes/' + recipes[i].pictureRef + '.jpg"' + '>' +
                '<div class="caption">' +
...
function loadRecipeFromId(id, portions) {
    ...
    socket.on('loadedRecipe', function (recipe) {
        ...
        var recipe_image =
            '<img class="recipe-image img-responsive img-rounded" data-failover="img/default.png" src="img/recipes/' + recipe[0].pictureRef + '.jpg">';
